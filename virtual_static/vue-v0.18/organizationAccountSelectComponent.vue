        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content text-center">
                <div class="modal-header py-2 bg-success text-white" style="cursor:move">
                    <h4 class="col">Organization and Budget Account</h4>
                    <button type="button" class="btn-close btn-close btn-close-white" @click="closeSearchModal"></button>
                </div>

                <div class="modal-body" style="min-height:150px;">
                    <div class="hstack">
                        <div id="orgListSwitch" class="col-5 vstack align-top mx-1" style="display:block; min-height:20px;">
                            <organization-list-component ref="organizationListComponent"
                                    ...
                                    @select-item="orgSelected"></organization-list-component>
                        </div>

                        <div class="col-7 vstack align-top mx-1" style="min-height:20px;">
...
export default {
    ...
    methods: {
        ...
        accountSelected(item, organization, month){
            ...
            this.accountItem.org_id = organization.id;
            this.accountItem.org_name = organization.org_name;
            this.accountItem.au_code = organization.au_code;
            this.accountItem.nas_code = organization.nas_code;
