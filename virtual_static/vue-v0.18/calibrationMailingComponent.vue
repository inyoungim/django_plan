        ...
        <div class="vstack col-6 align-top border rounded p-2 ms-2" style="overflow-x:auto">
            ...
            <div v-if="switchData == 'mailing_contents'">
                <div class="col mx-1 my-3">
                    <calibration-mailing-contents-component
                            ref="calibrationMailingContentsComponent"
                            :site="this.$props.site"
                            :lang="this.$props.lang"
...
export default {
    ...
    components: {
        ...
        'calibration-mailing-contents-component': Vue.defineAsyncComponent(
            () => loadModule('/static/vue-v0.18/calibrationMailingContentsComponent.vue', vueLoaderOptions) ),
    },
    data(){
        return {
            filter_enable : false,
    ...
    methods: {
        ...
        async loadData(event){
            ...
            var vm = this;
            await axios.get('./api/calibrationMailingList',
        ...
        async updateMailingList(mode){
            ...
            data.mode = mode;
            await axios.put('./api/calibrationMailingList', data)
                .then(function(res){
                    vm.itemList = res.data.itemList;
                })
                .catch(function(err){
