<template>
    <div class="col" >
        <div v-show="mode == 'modify'" class="col">
            <div id="keditor_asset_calibration" name="contents" required>
...
export default {
    ...
    methods : {
        ...
        kEditorInitial(id=null){
            var editor_id = "#keditor_asset_calibration";
            this.keditor =
                KEditor.build({
                    'instanceId':'1',
                    'wrapper': editor_id,
        ...
        async loadData(){
            ...
            var vm = this;
            await axios.get('./api/calibrationMailingContents', { params:{ div_name: vm.$props.div_name } })
                .then(function(res){
        ...
        async updateContents(){
            ...
            await axios.put('./api/calibrationMailingContents', data)
                .then(function(res){
                    vm.itemContents = res.data.itemContents;
                })
                .catch(function(err){
