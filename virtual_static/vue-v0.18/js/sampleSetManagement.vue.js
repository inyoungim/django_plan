...
const menuapp = Vue.createApp({
    delimiters: ['[[', ']]'],
    components: {
        'sample-set-list-component': Vue.defineAsyncComponent(
            () => loadModule('/static/vue-v0.18/sampleSetListComponent.vue', vueLoaderOptions) ),
        'sample-set-confirm-component': Vue.defineAsyncComponent(
            () => loadModule('/static/vue-v0.18/sampleSetConfirmComponent.vue', vueLoaderOptions) ),
    },
    data: function() {
        return {
            mode : '',
