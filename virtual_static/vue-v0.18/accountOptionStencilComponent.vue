<template>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
            <div class="modal-content text-center">
                <div class="modal-header py-2 bg-success text-white" style="cursor:move">
                    <h4 class="col">Account Option Stencil(PCB Stencil Cost Calculator)</h4>
    ...
    <div v-if="mode == 'new' || mode == 'modify' || mode == 'delete'" class="vue_modal" style="z-index: 9992;">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
            <div class="modal-content text-center">
                <div class="modal-header py-2 bg-success text-white" style="cursor:move">
                    <h4 class="col">Account Option Stencil(PCB Stencil Cost Calculator) Management</h4>
...
export default {
    ...
    methods: {
        ...
        async searchData(event){
            ...
            var vm = this;
            await axios.get('./api/accountOptionColumnStencilMaster/0',
        ...
        async submitFormModal(mode=null){
            ...
            await axios.post('./api/accountOptionColumnStencilMaster/0', vm.targetItem)
                .then(function(res){
                    vm.itemList = res.data.itemList;
                    vm.mode = "list";
                })
        ...
        async updateFormModal(){
            ...
            var vm = this;
            vm.targetItem.search_string = vm.search_string;
            await axios.put('./api/accountOptionColumnStencilMaster/'+vm.targetItem.id, vm.targetItem)
                .then(function(res){
                    vm.itemList = res.data.itemList;
                    vm.mode = "list";
                })
        ...
        async modal_ok(){
            ...
            var vm = this;
            if(vm.checked_ids[0]){
                await axios.delete('./api/accountOptionColumnStencilMaster/'+vm.checked_ids[0],
                    { params:{ search_string : vm.search_string } }
                    )
                    .then(function(res){
                        vm.itemList = res.data.itemList;
        ...
        async moveUpColumn(){
            ...
            vm.targetItem.search_string = vm.search_string;
            await axios.put('./api/accountOptionColumnStencilMaster/0', vm.targetItem)
                .then(function(res){
                    vm.itemList = res.data.itemList;
                    vm.mode = "list";
                })
