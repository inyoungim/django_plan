...
export default {
    ...
    methods: {
        ...
        async loadData(event){
            ...
            var vm = this;
            await axios.get('./api/approvalUserGroupAccountList/'+ vm.$props.user_group.id,
        ...
        async addUser(user){
            ...
            new_user.account_id = this.selectedItem.id;
            var data = { "div_name" : this.$props.div_name, "new_user" : new_user };

            this.showProgressModal = true;
            var vm = this;
            await axios.post('./api/approvalUserGroupAccountList/'+ vm.$props.user_group.id, data )
                .then(function(res){
                    vm.itemList = res.data.itemList;
                })
                .catch(function(err){
        ...
        async modal_ok(){
            this.showProgressModal = true;
            var vm = this;
            await axios.delete('./api/approvalUserGroupAccountList/'+vm.$props.user_group.id,
