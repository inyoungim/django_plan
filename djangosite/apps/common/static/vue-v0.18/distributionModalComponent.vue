        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content text-center">
                ...
                <div class="modal-body" style="min-height:100px;" id="form_validation">
                    ...
                    <div class="col mt-1">
                        <distribute-user-list-component
...
export default {
    ...
    components: {
        'distribute-user-list-component': Vue.defineAsyncComponent(
            () => loadModule('/static/vue-v0.18/distributeUserListComponent.vue', vueLoaderOptions) ),
    },
    data(){
        return {
